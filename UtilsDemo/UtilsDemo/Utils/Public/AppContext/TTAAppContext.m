...
{
    static TTAAppContext *sharedInstance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[TTAAppContext alloc] init];
...
{
    BOOL isOnline = NO;
    NSString *filepath = [[NSBundle mainBundle] pathForResource:@"TTANetworkConfigurations" ofType:@"plist"];
